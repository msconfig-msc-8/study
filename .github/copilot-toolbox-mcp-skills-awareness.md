...
_Generated: 2026-04-24T00:06:07.225Z_
...
Workspace `mcp.json` _(folder: MyStudy)_

- **d:\My files ol laptop\D_disk_files\Ddisk\UNIVER\2_курс\MyStudy\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Legion_5\AppData\Roaming\Code\User\mcp.json** — _File missing_
